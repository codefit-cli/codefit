...
func TestDiffFirstScanAllNew(t *testing.T) {
	...
	res := baseline.Diff(prev, []baseline.Observed{surf("a", "overfetch", "a.ts"), surf("b", "authz", "b.ts")}, secScope(), scope.Full())
...
func TestDiffKnownSurfaceSilenced(t *testing.T) {
	...
	res := baseline.Diff(prev, []baseline.Observed{surf("a", "overfetch", "a.ts")}, secScope(), scope.Full())
...
func TestDiffKnownDeterministicStillShown(t *testing.T) {
	...
	res := baseline.Diff(prev, []baseline.Observed{affirm("sec", "c.ts")}, secScope(), scope.Full())
	if !res.Shown["sec"] {
...
func TestDiffGoneLingers(t *testing.T) {
	...
	res := baseline.Diff(prev, nil, secScope(), scope.Full())
...
func TestDiffChangedReplacesOld(t *testing.T) {
	...
	res := baseline.Diff(prev, []baseline.Observed{surf("new", "overfetch", "a.ts")}, secScope(), scope.Full())
...
func TestDiffChangedDropsAck(t *testing.T) {
	...
	res := baseline.Diff(prev, []baseline.Observed{{FP: "new", Category: "security", File: "c.ts", Affirms: true}}, secScope(), scope.Full())
